    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("btnUpdate") != null)
        {
            ...
            if(password.equals(confirmPassword)){
                ...
                customer.setId(HelperUtil.parseInt(customerId));
        ...
        Customer customer = CustomerDAO.fetch(HelperUtil.parseInt(customerId));
        List<Invoice> invoices = InvoiceDAO.fetchByCustomer(customer.getId());
