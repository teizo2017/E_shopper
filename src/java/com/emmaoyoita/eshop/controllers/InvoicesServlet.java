...
public class InvoicesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            Invoice invoice = InvoiceDAO.fetch(HelperUtil.parseInt(request.getParameter("iid")));
            if(invoice != null){
        ...
        request.getRequestDispatcher("/admin/view-invoices.jsp").forward(request, response);
    }
